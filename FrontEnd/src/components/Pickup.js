    ...
    return (
        <div className="row row-cols-2 row-cols-md-3 mb-2" style={{ color: "darkgray" }}>
            ...
            <div className="col-sm-8 offset-md-1 py-2 text-left  d-grid gap-1" style={{ border: "2px solid purple", width: "30%", height: "20%", borderRadius: "20px" }}>
                ...
                <h5>Select Date : </h5>
                <input type={"date"} value={Ordercreate.p_date} required name="p_date" onChange={handleChange} ></input>
                <h5>Select Time : </h5>
                <input type={"time"} value={Ordercreate.p_time} required name="p_time" onChange={handleChange}></input>

...
import all1 from "../3.jpg"
import car1 from "../carImages/101.jpeg"
const Showroom=()=>{
...
return (
    <div className="container-fluid text-light" style={{backdropFilter:`blur(12px)`}}>
       <h3 className="text-center" style={{color:"lightsalmon"}}>List Of Available Cars</h3>
        <div className="container-fluid text-light" style={{border:"2px solid white",height:"600px",width:"90%",overflowY:"scroll"}}>
        ...
        /> If You need Driver,Select the Checkbox
